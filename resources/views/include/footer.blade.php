...
<div class="footer">
  <p>
    <footer id="footer" class="footer-1">
      ...
      <h4 class="widget-title">Data Wholesale<span></span></h4>
      <p> Here at Datawholesale.com, we offer you the most affordable and most cheapest Data and Airtime </p>
      </div>
      </div>
      
      <div class="col-xs-12 col-sm-6 col-md-3">
      <div class="widget no-box">
      <h4 class="widget-title">Resources<span></span></h4>
      ...
      <div class="thumb-content"><a href="#.">Princing</a></div> 
      ...
      <div class="col-xs-12 col-sm-6 col-md-3">
      <div class="widget no-box">
      <h4 class="widget-title">Products<span></span></h4>
      
        <div class="thumb-content"><a href="#.">Data</a></div> 
        
        <div class="thumb-content"><a href="#.">Recharge Card</a></div> 
      ...
      <div class="col-md-12 text-center">
        <p style="text-align: center">copyright &copy;2022 <a href="#">Codeplateau 3.0 Developers</a></p>
      </div>
      </div>
      </div>
      </div>
